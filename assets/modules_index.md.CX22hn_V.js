import{_ as a,c as n,o as e,ag as p}from"./chunks/framework.BZemHgQ6.js";const u=JSON.parse('{"title":"Modules","description":"","frontmatter":{"home":false,"prev":false,"next":false},"headers":[],"relativePath":"modules/index.md","filePath":"modules/index.md"}'),t={name:"modules/index.md"};function i(l,s,o,c,r,d){return e(),n("div",null,s[0]||(s[0]=[p(`<h1 id="modules" tabindex="-1">Modules <a class="header-anchor" href="#modules" aria-label="Permalink to &quot;Modules&quot;">​</a></h1><p>SuperDoc can be extended via modules. There are several modules available currently.</p><p>You can add a module by passing in a config for it in the main SuperDoc config:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const config {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="default-toolbar-buttons" tabindex="-1">Default toolbar buttons <a class="header-anchor" href="#default-toolbar-buttons" aria-label="Permalink to &quot;Default toolbar buttons&quot;">​</a></h3><p>See all buttons in defaultItems.js</p><h2 id="customizing-toolbar-buttons" tabindex="-1">Customizing toolbar buttons <a class="header-anchor" href="#customizing-toolbar-buttons" aria-label="Permalink to &quot;Customizing toolbar buttons&quot;">​</a></h2><p>⚠️ <strong>Requires SuperDoc &gt; 0.11.40</strong></p><h3 id="adding-a-custom-button" tabindex="-1">Adding a custom button <a class="header-anchor" href="#adding-a-custom-button" aria-label="Permalink to &quot;Adding a custom button&quot;">​</a></h3><p>You can create a custom toolbar buttons in SuperDoc to perform custom actions.</p><p><a href="https://github.com/Harbour-Enterprises/SuperDoc/tree/main/examples/vue-custom-mark" target="_blank" rel="noreferrer">Please see an example of creating buttons with different commands, as well as a custom dropdown here</a></p><p>To create a custom button, simply create a JSON config. This will be generated using the use-toolbar-button composable. <a href="https://github.com/Harbour-Enterprises/SuperDoc/blob/main/packages/super-editor/src/components/toolbar/use-toolbar-item.js" target="_blank" rel="noreferrer">See the composable for all available options</a>.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const myBasicButtonConfig = {</span></span>
<span class="line"><span>  type: &#39;button&#39;,</span></span>
<span class="line"><span>  name: &#39;insertCustomMark&#39;,</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // Since this command is already in editor.commands (from the custom-mark extension), we can use the command name directly</span></span>
<span class="line"><span>  command: &#39;setMyCustomMark&#39;,</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  tooltip: &#39;Insert Custom Mark&#39;,</span></span>
<span class="line"><span>  group: &#39;center&#39;,</span></span>
<span class="line"><span>  icon: headphonesSVG, // You can use a custom icon here</span></span>
<span class="line"><span>};</span></span></code></pre></div><p>Alternatively, you can also pass in a function instead of an existing command name:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const myBasicButtonConfig = {</span></span>
<span class="line"><span>  type: &#39;button&#39;,</span></span>
<span class="line"><span>  name: &#39;insertCustomMark&#39;,</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // We can also pass in a function as the command</span></span>
<span class="line"><span>  // All commands receive:</span></span>
<span class="line"><span>  //     item (the currently-clicked button)</span></span>
<span class="line"><span>  //     argument (some argument value, if any)</span></span>
<span class="line"><span>  //     option (the entire option from the options array, for dropdowns)</span></span>
<span class="line"><span>  command: ({ item, argument, option }) =&gt; {</span></span>
<span class="line"><span>    const id = Math.random().toString(36).substring(2, 7);</span></span>
<span class="line"><span>    return superdoc.value?.activeEditor?.commands.setMyCustomMark(id);</span></span>
<span class="line"><span>  },</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  tooltip: &#39;Insert Custom Mark&#39;,</span></span>
<span class="line"><span>  group: &#39;center&#39;,</span></span>
<span class="line"><span>  icon: headphonesSVG, // You can use a custom icon here</span></span>
<span class="line"><span>};</span></span></code></pre></div><p>Example of creating a custom dropdown:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const customDropDown = {</span></span>
<span class="line"><span>  type: &#39;dropdown&#39;,</span></span>
<span class="line"><span>  name: &#39;customDropdown&#39;,</span></span>
<span class="line"><span>  command: ({ item, argument, option }) =&gt; {</span></span>
<span class="line"><span>    if (!item || !option) return; // Case where the dropdown is being expanded or collapsed but no option selected</span></span>
<span class="line"><span>    const { key, label } = option; // This is from the options array defined below</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    // Do something with the selected option here</span></span>
<span class="line"><span>    // For example, we can call a command or a custom function based on the key</span></span>
<span class="line"><span>    if (key === &#39;custom-mark&#39;) {</span></span>
<span class="line"><span>      superdoc.value?.activeEditor?.commands.setMyCustomMark();</span></span>
<span class="line"><span>    } else if (key === &#39;export-docx&#39;) {</span></span>
<span class="line"><span>      exportDocx();</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  },</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  tooltip: &#39;Custom Dropdown&#39;,</span></span>
<span class="line"><span>  group: &#39;center&#39;,</span></span>
<span class="line"><span>  icon: chevronDownSVG,</span></span>
<span class="line"><span>  hasCaret: true,</span></span>
<span class="line"><span>  suppressActiveHighlight: true,</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // Dropdown options</span></span>
<span class="line"><span>  options: [</span></span>
<span class="line"><span>    { label: &#39;Insert Custom Mark&#39;, key: &#39;custom-mark&#39;, },</span></span>
<span class="line"><span>    { label: &#39;Export to DOCX&#39;, key: &#39;export-docx&#39;, },</span></span>
<span class="line"><span>  ],</span></span>
<span class="line"><span>};</span></span></code></pre></div><p>Finally, simply pass in a list of custom buttons to your toolbar config:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const mySuperDocConfig = {</span></span>
<span class="line"><span>  ...config, // The rest of your SuperDoc config</span></span>
<span class="line"><span>  modules: {</span></span>
<span class="line"><span>    // Other module config</span></span>
<span class="line"><span>    toolbar: {</span></span>
<span class="line"><span>      // Other toolbar config</span></span>
<span class="line"><span>      customButtons: [</span></span>
<span class="line"><span>        customDropDown,</span></span>
<span class="line"><span>        myBasicButtonConfig,</span></span>
<span class="line"><span>      ]</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h1 id="fields" tabindex="-1">Fields <a class="header-anchor" href="#fields" aria-label="Permalink to &quot;Fields&quot;">​</a></h1><p>SuperDoc by default has the <strong>fields</strong> extension enabled. You can learn more about the <a href="https://github.com/Harbour-Enterprises/SuperDoc/blob/main/packages/super-editor/src/extensions/field-annotation/field-annotation.js" target="_blank" rel="noreferrer"><strong>Field Annotation</strong> node here</a></p><p>Fields can be used when placeholder / variable content is needed inside the document. They can contain various types of data:</p><ul><li>Plain text</li><li>HTML rich text</li><li>Images</li><li>Links</li><li>Checkboxes</li></ul><h2 id="commands-1" tabindex="-1">Commands <a class="header-anchor" href="#commands-1" aria-label="Permalink to &quot;Commands&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// Add a field annotation at the specified position</span></span>
...
<span class="line"><span>superdoc.export({ isFinalDoc: true })</span></span></code></pre></div>`,75)]))}const m=a(t,[["render",i]]);export{u as __pageData,m as default};

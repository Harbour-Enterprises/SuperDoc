 ...
 * @property {HTMLElement|null} [paginationMeasurementElement=null] - Optional element to host the pagination measurement editor
 * @property {(params: {
 *   permission: string,
 *   role?: string,
 *   isInternal?: boolean,
...
export class Editor extends EventEmitter {
  ...
  options = {
    ...
    paginationMeasurementElement: null,
    lastSelection: null,
  ...
  #initDevTools() {
    ...
    if (process.env.NODE_ENV === 'development' || this.options.isDebug) {
      window.superdocdev = {
        ...
        editor: this,
        // Convenience function to toggle pagination spacing debug visualization
        togglePaginationSpacing: () => {
          this.commands.togglePaginationSpacingDebug();
        },
      };
    }
  }

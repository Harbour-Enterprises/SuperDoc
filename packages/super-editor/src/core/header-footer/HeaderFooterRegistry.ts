...
type HeaderFooterCollections = {
  ...
  headerIds?: Record<string, string | string[] | boolean | undefined>;
  footerIds?: Record<string, string | string[] | boolean | undefined>;
};

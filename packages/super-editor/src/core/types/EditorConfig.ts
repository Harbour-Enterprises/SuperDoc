...
import type { FontsResolvedPayload } from './EditorEvents.js';
...
export interface EditorOptions {
  ...
  customUpdatedFiles?: Record<string, any>;
  ...
  onTrackedChangesUpdate?: (params: any) => void;

  /** Called when comments update */
  onCommentsUpdate?: (params: any) => void;

  /** Called when comments are loaded */
  onCommentsLoaded?: (params: any) => void;

  /** Called when a comment is clicked */
  onCommentClicked?: (params: any) => void;

  /** Called when comment locations update */
  onCommentLocationsUpdate?: (params: any) => void;

  /** Called when document is locked */
  onDocumentLocked?: (params: any) => void;

  /** Called on first render */
  onFirstRender?: () => void;

  /** Called when collaboration is ready */
  onCollaborationReady?: (params: any) => void;

  /** Called when pagination updates */
  onPaginationUpdate?: (params: any) => void;

  /** Called when an exception occurs */
  onException?: (params: any) => void;

  /** Called when list definitions change */
  onListDefinitionsChange?: (params: any) => void;

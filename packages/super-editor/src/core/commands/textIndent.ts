 ...
 */
export const increaseTextIndent = (): Command => modifyIndentation((node) => calculateNewIndentation(node, 1));
 ...
 */
export const decreaseTextIndent = (): Command => modifyIndentation((node) => calculateNewIndentation(node, -1));
 ...
 */
export const setTextIndentation = (points: number): Command => modifyIndentation(() => ptToTwips(points));
 ...
 */
export const unsetTextIndentation = (): Command => modifyIndentation(() => null);
 ...
 * @returns {Function} Command function
 */
function modifyIndentation(calcFunc: (node: Node) => number | null): Command {

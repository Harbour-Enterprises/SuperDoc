...
> {
  ...
  parseDOM?: MaybeGetter<any[]>;

  /** The DOM rendering function */
  renderDOM?: MaybeGetter<any>;
  ...
  addHelpers?: MaybeGetter<Record<string, (...args: any[]) => any>>;
  ...
  extendNodeSchema?: MaybeGetter<any>;

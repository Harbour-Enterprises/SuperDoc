export const extractListLevelStyles = (
  cssText: string,
  listId: string,
  level: string,
  numId: string,
...
export function resolveStyles(
  extractedStyles: Record<string, string> | null,
...
function getStartNumber(lvlText: string): number | null {
...
function getStartNumberFromAlpha(lvlText: string): number | null {
...
function getStartNumberFromRoman(lvlText: string): number | null {

...
import { translator as wSdtContentNodeTranslator } from './v3/handlers/w/sdtContent/sdtcontent-translator';
...
export function exportSchemaToJson(params) {
  ...
  const router = {
    ...
    structuredContent: wSdtContentNodeTranslator,
    structuredContentBlock: wSdtContentNodeTranslator,

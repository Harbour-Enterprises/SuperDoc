 ...
 * @typedef {Object} AppendRowsWithContentToTableOptions
...
export const Table = Node.create({
  ...
  addCommands() {
    return {
       ...
       * @category Command
       * @param {AppendRowsWithContentToTableOptions} options - Append configuration
       * @example
       * editor.commands.appendRowsWithContentToTable({ tablePos, valueRows: [['A','B'], ['C','D']], copyRowStyle: true })
       */
 ...
 */
function defineTableForRowAppend(tr, tablePos, tableNode) {

...
import type { AIBuilderToolDefinition, AIBuilderToolHandlerResult } from '../types';
 ...
 */
export function createRespondTool(): AIBuilderToolDefinition {
    return {
        name: 'respond',
        description:
        ...
        handler: async ({instruction, step}): Promise<AIBuilderToolHandlerResult> => ({
            success: true,

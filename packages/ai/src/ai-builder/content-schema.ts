 ...
 *
 * NOTE: This is a fallback schema. The getContentSchema tool will attempt to use
 * the dynamic schema from editor.getSchemaSummaryJSON() which provides a complete
 * schema with all available nodes, marks, and attributes based on loaded extensions.
 */

/**
 * The content schema for SuperDoc documents
 *
 * This is a basic fallback schema. For full schema including all extensions,
 * use getContentSchema tool which calls editor.getSchemaSummaryJSON().
 */

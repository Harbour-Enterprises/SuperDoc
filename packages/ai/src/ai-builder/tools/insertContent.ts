...
export const insertContent: SuperDocTool = {
    name: 'insertContent',
    description: 'Insert new content into the document. Position can be "selection" (at cursor), "documentStart", or "documentEnd". Content should be an array of paragraph blocks in ProseMirror JSON format.',
    category: 'write',

...
describe('AIActions', () => {
    ...
    describe('find', () => {
        ...
        it('should return empty when no document context', async () => {
            const actions = new AIActions(mockProvider, mockEditor, user, '', false);
    ...
    describe('insertContent', () => {
        ...
        it('should return failure when no editor', async () => {
            const actions = new AIActions(mockProvider, null, user, mockEditor.state.doc.textContent, false);
    ...
    describe('error handling', () => {
        it('should respect enableLogging flag', async () => {
            ...
            const actions1 = new AIActions(mockProvider, mockEditor, user, 'context', false);

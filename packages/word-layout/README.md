...
Shared Word paragraph and list layout math for SuperDoc. Provides pure, data-driven functions for marker spacing, tab stops, numbering counters, and paragraph layout calculations used across both super-editor and layout-engine.
...
- `tab-layout.test.ts` – tab stop resolution

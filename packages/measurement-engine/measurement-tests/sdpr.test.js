...
const EXPECTED_SNAPSHOT_PATH = path.resolve(__dirname, './sdpr.expected.json');

let harness;

beforeAll(async () => {
  harness = await createMeasurementHarness('sdpr.docx');
});
...
describe('sdpr measurement regression', () => {

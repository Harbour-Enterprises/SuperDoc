 ...
 *
 * Notes:
 * - Aggregates coverage for super-editor, superdoc, superdoc-ai, and measurement-engine.
    ...
    if (code === 0) {
      ...
      if (fs.existsSync(summaryPath)) {
        ...
        const packages = [
          ...
          {
            name: 'superdoc-ai',
            label: 'superdoc-ai package',
            absPrefix: normalize(path.join(repoRoot, 'packages', 'superdoc-ai')) + '/',
          ...
          },
          {
            ...
            absPrefix:
              normalize(path.join(repoRoot, 'packages', 'measurement-engine', 'engine')) + '/',

...
const handleLowerRoman: NumberingHandler = (path, lvlText) => handleRoman(path, lvlText).toLowerCase();
const handleAlpha: NumberingHandler = (path, lvlText) => generateNumbering(path, lvlText, intToAlpha);
const handleLowerAlpha: NumberingHandler = (path, lvlText) => handleAlpha(path, lvlText).toLowerCase();

...
export class SuperDoc extends EventEmitter<string | symbol, any> {
    ...
    socket: any;
    isDev: boolean;
    activeEditor: import("@harbour-enterprises/super-editor").Editor;
    comments: any[];
    readyEditors: number;
    isLocked: boolean;
    lockedBy: User;
    ...
    toggleAnnotationMode(state: any): void;
     ...
     */
    export({ exportType, commentsType, exportedName, additionalFiles, additionalFileNames, isFinalDoc, triggerDownload, }?: {
        exportType?: string[];
        commentsType?: string;
        exportedName?: string;
        additionalFiles?: any[];
     ...
     */
    exportEditorsToDOCX({ commentsType, isFinalDoc }?: {
        commentsType?: string;
        isFinalDoc?: boolean;
    }): Promise<Array<Blob>>;
...
export type Editor = import("@harbour-enterprises/super-editor").Editor;

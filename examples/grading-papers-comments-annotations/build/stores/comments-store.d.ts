export const useCommentsStore: import("pinia").StoreDefinition<"comments", Pick<{
    ...
    checkOverlaps: (currentElement: any, dialog: any, doc: any) => void;
    ...
    handleEditorLocationsUpdate: (allCommentPositions: any, activeThreadId: any) => void;
...
}, "setActiveComment" | "init" | "getComment" | "getCommentLocation" | "hasOverlapId" | "checkOverlaps" | "getPendingComment" | "showAddComment" | "addComment" | "cancelComment" | "deleteComment" | "removePendingComment" | "processLoadedDocxComments" | "translateCommentsForExport" | "handleEditorLocationsUpdate" | "handleTrackedChangeUpdate">>;
